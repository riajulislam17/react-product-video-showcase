...
var Maximize = (props) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("svg", { ...props, fill: "none", xmlns: "http://www.w3.org/2000/svg", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
  "path",
  {
...
var Minimize = (props) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("svg", { ...props, fill: "none", xmlns: "http://www.w3.org/2000/svg", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
  "path",
  {
...
var ArrowUp = (props) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
  "svg",
  {
    ...props,
    fill: "none",
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("path", { d: "M12 19V5M5 12l7-7 7 7" })
  }
);
var ArrowDown = (props) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
  "svg",
  {
    ...props,
    fill: "none",
    ...
    viewBox: "0 0 24 24",
    xmlns: "http://www.w3.org/2000/svg",
    children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("path", { d: "M12 5v14M19 12l-7 7-7-7" })
  }
);
var ArrowLeft = (props) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
  "svg",
  {
    ...props,
    fill: "none",
    ...
    viewBox: "0 0 24 24",
    xmlns: "http://www.w3.org/2000/svg",
    children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("path", { d: "M19 12H5M12 5l-7 7 7 7" })
  }
);
var ArrowRight = (props) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
  "svg",
  {
    ...props,
    fill: "none",
    ...
    viewBox: "0 0 24 24",
    xmlns: "http://www.w3.org/2000/svg",
    children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("path", { d: "M5 12h14M12 5l7 7-7 7" })
  }
);
...
var ProductCard = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "relative aspect-[4/5] md:aspect-[5/6] w-full bg-black flex items-center justify-center", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(VideoPlayer, { videoUrl: product.videoUrl, videoConfig: finalConfig }),
          expandCard && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
            "button",
            {
              type: "button",
              title: "Expand",
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Maximize, { className: "text-white  w-8 h-8" })
            }
          )
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex flex-col", children: [
          contents && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { children: contents }),
          buttons && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { children: buttons })
        ] })
      ]
    }
  ) });
...
var ProductModalY = ({
  ...
  const [index, setIndex] = (0, import_react3.useState)(activeIndex);
  const containerRef = (0, import_react3.useRef)(null);
  const cardRefs = (0, import_react3.useRef)([]);
  ...
  const touchStartY = (0, import_react3.useRef)(null);
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          "button",
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Minimize, { "aria-label": "Close modal", className: "w-6 h-6 text-white" })
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "hidden md:flex flex-col absolute right-4 top-1/2 -translate-y-1/2 z-50 space-y-3", children: [
          index > 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            "button",
            {
              onClick: () => setIndex(index - 1),
              className: "p-3 bg-white/60 rounded-full hover:bg-white/80 cursor-pointer",
              children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ArrowUp, { className: "w-6 h-6 text-black" })
            }
          ) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", {}),
          index < products.length - 1 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            "button",
            {
              onClick: () => setIndex(index + 1),
              className: "p-3 bg-white/60 rounded-full hover:bg-white/80 cursor-pointer",
              children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ArrowDown, { className: "w-6 h-6 text-black" })
            }
          ) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", {})
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          "div",
          {
            ...
            children: products.map((product, i) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
              "div",
              {
                ref: (el) => {
                ...
                ${animating && i === index ? "scale-95 opacity-50" : "scale-100 opacity-100"}`,
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "relative flex-grow w-full flex items-center justify-center bg-black", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                        VideoPlayer,
                        {
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "p-4 space-y-3 w-full bg-black/30", children: [
...
var ProductModalX = ({
  ...
  const [index, setIndex] = (0, import_react4.useState)(activeIndex);
  const [animating, setAnimating] = (0, import_react4.useState)(false);
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
          "button",
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Minimize, { className: "w-6 h-6 text-white" })
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "hidden md:flex flex-row absolute top-1/2 -translate-y-1/2 z-50 justify-between w-full px-4", children: [
          index > 0 ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
            "button",
            {
              onClick: () => setIndex(index - 1),
              className: "p-3 bg-white/60 rounded-full hover:bg-white/80 cursor-pointer",
              children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(ArrowLeft, { className: "w-6 h-6 text-black" })
            }
          ) : /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", {}),
          index < products.length - 1 ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
            "button",
            {
              onClick: () => setIndex(index + 1),
              className: "p-3 bg-white/60 rounded-full hover:bg-white/80 cursor-pointer",
              children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(ArrowRight, { className: "w-6 h-6 text-black" })
            }
          ) : /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", {})
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "w-full h-full flex justify-center items-center overflow-hidden", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
          "div",
          {
            className: `w-full max-w-lg md:max-w-2xl h-screen max-h-screen flex flex-col items-center bg-black text-white overflow-hidden rounded shadow-lg transition-all duration-300 ease-in-out 
            ${animating ? "scale-95 opacity-50" : "scale-100 opacity-100"}`,
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "relative flex-grow w-full flex items-center justify-center bg-black", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                VideoPlayer,
                {
              ...
              /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "p-4 space-y-3 w-full bg-black/30", children: [
...
function useDeviceType() {
  const [device, setDevice] = (0, import_react5.useState)(
    "desktop"
  );
...
var ProductGrid = ({
  ...
  const [activeIndex, setActiveIndex] = (0, import_react6.useState)(null);
  ...
  const [currentPage, setCurrentPage] = (0, import_react6.useState)(initialPage);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { children: [
      sectionHeader && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "mb-4", children: sectionHeader({
        handleNext,
        handlePrev,
        isSliding: slide
      }) }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
        "div",
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "flex", children: [...Array(totalPages)].map((_, pageIndex) => {
              ...
              "div",
              {
                ...
                children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
                  "div",
                  {
                    ...
                    children: pageItems.map((product, index) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
                      ProductCard,
                      {
                        product,
                        videoConfig,
    ...
    expandCard && activeIndex !== null && (expandCardSlide === "vertical" ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
      ProductModalY,
      {
...
function App() {
  const renderSectionHeader = ({
    ...
    handlePrev,
    isSliding
  }) => /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "flex justify-between items-center gap-4 my-4", children: [
    isSliding && /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "flex gap-2", children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
        "button",
        {
          className: "p-3 bg-gray-300 text-black cursor-pointer rounded-full",
          onClick: handlePrev,
          children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(ArrowLeft, { className: "text-black w-6 h-5" })
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
        "button",
        {
          className: "p-3 bg-gray-300 text-black cursor-pointer rounded-full",
          onClick: handleNext,
          children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(ArrowRight, { className: "text-black w-6 h-5" })
        }
      )
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("h1", { className: "text-2xl font-bold text-center underline uppercase", children: [
      "Video Products ",
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("small", { children: "(backward - horizontal)" })
    ] })
  ] });
  const renderContents = (product) => {
    return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "hidden md:block", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "flex justify-between items-center gap-3 w-full my-1.5", children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("h3", { className: "text-medium font-semibold text-primary", children: product.title }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: " font-semibold text-primary flex items-center gap-1", children: [
          product.currency,
          " ",
          (product?.discountPrice ?? 0) > 0 && (product?.discountPrice ?? 0) < product.price ? /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "line-through text-gray-500 text-md", children: product.price }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "text-gray-700 ml-2 text-xl", children: product.discountPrice })
          ] }) : /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "text-gray-700 ml-2 text-xl", children: product.price })
        ] })
      ] }) }),
      /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "block md:hidden", children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("h3", { className: "text-medium font-semibold text-primary", children: product.title }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: " font-semibold text-primary flex items-center gap-1", children: [
          product.currency,
          " ",
  ...
  const renderButtons = (product) => {
    return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "block md:hidden", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "flex flex-col gap-3 w-full my-1.5", children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
          "button",
          {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(import_jsx_runtime7.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "p-5 md:p-10 lg:px-20", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
    ProductGrid,
    {
...
import_react_dom.default.render(
  /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(import_react7.default.StrictMode, { children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(App_default, {}) }),
